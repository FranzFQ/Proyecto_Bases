...
class Ventana_usuarios(Codigo):
    ...
    def agregar_usuario(self):
        ...
        label_nombre.setStyleSheet("color: Black; font-size: 15px")
        ...
        label_email.setStyleSheet("color: Black; font-size: 15px")
        ...
        label_telfono.setStyleSheet("color: Black; font-size: 15px")
        ...
        label_puesto.setStyleSheet("color: Black; font-size: 15px")
        ...
        label_contrasennia.setStyleSheet("color: Black; font-size: 15px")
